...
{
    public const string Background = "gray-100";
    public const string BackgroundDarker = "gray-200";
    public const string Text = "gray-700";
    public const string PrimaryColorLigther = "gray-600";
    public const string PrimaryColor = "gray-700";
    public const string PrimaryColorDarker = "gray-800";
